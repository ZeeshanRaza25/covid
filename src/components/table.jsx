...
export default function TableDetail() {
    ...
    return (
        <Grid container alignItems="center" alignContent="center" justify="center" className={classes.container} >
            <Grid item xs={4} className={classes.countrSelector}>
                <Autocomplete
                    ...
                    onChange={(option, value) => { console.log(value) }}
                    renderInput={(params) => (
                        <TextField
                            {...params}
                    ...
                    <Table className={classes.table} aria-label="customized table">
                        <TableHead>
                            <TableRow>
                                ...
                                <StyledTableCell align="center">Active Cases</StyledTableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            {countries.map((row) => (
                                <StyledTableRow key={row.country}>
                                    <StyledTableCell component="th" scope="row" align="center" size="small" >
                                        {/* <Avatar variant='square' alt="Remy Sharp" src={row.countryInfo.flag} /> */}
                                        {row.country}
                                    </StyledTableCell>
                                    <StyledTableCell align="center">{row.cases}</StyledTableCell>
